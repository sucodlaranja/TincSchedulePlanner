...
import { parseDate, formatShortDate } from '@/lib/calendar-utils'
...
export default function CalendarView() {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {hasIssues && (
        <div className={`shrink-0 border-t ${configWarnings.length > 0 ? 'border-red-200 bg-red-50' : 'border-amber-200 bg-amber-50'}`}>
          <button
